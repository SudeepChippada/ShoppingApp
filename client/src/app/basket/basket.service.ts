...
export class BasketService {
  ...
  // that will make use of in the components that connects to this observable (basket$).
  getBasket(id: string) {
  ...
  removeItemFromBasket(item: IBasketItem) {
    ...
    if (basket.items.some(x => x.id === item.id)) {
      // Using filter method we will return all of the other items other than this particular item based on the id.
